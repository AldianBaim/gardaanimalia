        ...
        <main>
          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <p className="lead">
                Laporkan semua bentuk perdagangan, perburuan, pemeliharaan dan
                kekejaman terhadap satwa liar dilindungi. Laporan ini akan
                disampaikan kepada pihak berwenang untuk ditindaklanjuti.
                Bersama-sama kita bisa melindungi satwa liar di Indonesia!
              </p>
              <form action="" method="post">
                <div className="form-group mb-2">
                  ...
                  />
                  <p className="lead">
                    Kerahasiaan pelapor dijamin, kontak hanya akan digunakan
                    saat dibutuhkan keterangan tambahan.
                  </p>
                </div>
                <div className="form-group mb-2">
                ...
                <div className="form-group mb-2">
                  ...
                  <p className="text-muted">
                    Offline: Pasar burung dan pasar hewan, Online: Perdagangan
                    melalui facebook/instagram/e-commerce
                  </p>
                </div>
                <div className="form-group mb-2">
                  <label htmlFor="name" className="form-label">
                    Lokasi Temuan <span className="text-danger">*</span>
                  </label>
                  <input
                    type="text"
                    className="form-control mb-1"
                  ...
                  />
                  <p className="text-muted">
                    Masukkan alamat jelas atau link website
                  </p>
                </div>
                <div className="form-group mb-2">
                  <label htmlFor="name" className="form-label">
                    Hari dan Tanggal <span className="text-danger">*</span>
                  </label>
                  <input
                    type="date"
                    className="form-control mb-1"
                ...
                <div className="form-group mb-2">
                  <label htmlFor="name" className="form-label">
                    Jenis Satwa <span className="text-danger">*</span>
                  </label>
                  <input
                    type="text"
                    className="form-control mb-1"
                ...
                <div className="form-group mb-3">
                  <label htmlFor="message" className="form-label">
                    Untuk mempermudah penyelidikan, silahkan unggah foto lokasi
                    dan satwa
                  </label>
                  <input
                    type="file"
                ...
                <button
                  type="submit"
                  className="btn btn-dark rounded-0 shadow-sm"
                >
                  Submit
                </button>
              </form>
              ...
              <div className="d-flex mt-5 justify-content-evenly">
                <div className="d-flex align-items-center gap-2">
                  <div className="d-flex gap-2">
                    <a
                      href="https://facebook.com/pembelasatwaliar"
                      target="_blank"
                    >
                  ...
                  <div className="d-flex gap-2">
                    <a
                      href="https://www.instagram.com/pembelasatwaliar"
                      target="_blank"
                    >
                ...
                <a
                  href="https://www.youtube.com/c/GARDAANIMALIA/videos"
                  target="_blank"
                  className="btn btn-danger rounded-0 shadow"
                >
                  Youtube
                </a>
              </div>
            ...
            <div className="col-lg-4">
              ...
              <div className="card position-relative mb-3">
                <img
                  src="https://ik.imagekit.io/8jggdaymrs/gardaanimalia/Screenshot%202024-12-20%20at%2020.03.11.png"
                  className="w-100"
                ...
                <div className="d-flex p-3 gap-2 position-absolute bottom-0">
                  <div className="text-white">
                    <div className="text-xs">
                      Air dan Api Diserahkan ke BKSD
                    </div>
              ...
              {[...Array(5)].map((item, index) => (
                <div key={index} className="row mb-3">
                  <div className="col-lg-3 pe-0">
                    <img
                      src="https://ik.imagekit.io/8jggdaymrs/gardaanimalia/Screenshot%202024-12-20%20at%2020.00.07.png"
                      className="w-100"
                      alt=""
                    />
                  </div>
                  <div className="col-lg-9">
                    <div className="text-xs">
                      Penyu Hijau Mati Terdampar di Pantai Legian, Diduga
                      Dehidrasi
                    </div>
              ...
              <div className="card position-relative mb-3">
                ...
                >
                  ...
                  <div className="text-white">
                    <div className="text-xs">
                      Jual konten penyiksaan monyet, pria asal Singkawan
                    </div>
                    <div className="text-xs">11/11/2024</div>
                  </div>
                </div>
